...
class Goods(models.Model):
    ...
    goods_id= models.ManyToManyField(to=Store,verbose_name="商品店铺")

class GoodsImg(models.Model):
    img_address = models.ImageField(upload_to="store/images",verbose_name="商品地址")
    img_description = models.TextField(max_length=32,verbose_name="商品描述")
    goods_id = models.ForeignKey(to = Goods,on_delete=models.CASCADE,verbose_name="商品名称")
