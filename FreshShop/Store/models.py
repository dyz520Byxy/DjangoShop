...
class GoodsTypeManager(Manager):
    def addType(self,name,picture = "buyer/images/goods_detail.jpg"):
...
class Goods(models.Model):
    ...
    goods_under = models.IntegerField(verbose_name="商品状态",default=1) #1待售 0下架

    goods_type = models.ForeignKey(to=GoodsType,on_delete=models.CASCADE,verbose_name="图片类型",default=1)
